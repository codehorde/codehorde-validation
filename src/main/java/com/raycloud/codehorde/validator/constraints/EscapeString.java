 ...
 * <p>
 * 有关XSS问题，处理的原则：<br>
 * 1. 不是所有的field都需要XSS处理，如枚举的字符串只需要做枚举校验即可com.raycloud.common.validator.constraints.EnumString<br>
...
public @interface EscapeString {
    ...
    String message() default "{com.raycloud.common.validator.constraints.EscapeString.message}";
